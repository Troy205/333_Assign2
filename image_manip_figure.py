...
#center at 430, 481
#yint at 596, 308
polarised = img.imread("Figure_1.png")

new_polar, red_line = get_component(polarised, 0, 596-3, 308-250-85, 430-3, 481-250-85)
_, green_line = get_component(polarised, 1, 596-3, 308-250-85, 430-3, 481-250-85)
_, blue_line = get_component(polarised, 2, 596-3, 308-250-85, 430-3, 481-250-85)
